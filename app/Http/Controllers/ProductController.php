...
//             }
        ...
        $gmv_products=array();
         ...
         $gmv_products=array_unique($gmv_products); // to repeated items
              // dd($gmv_products);
    ...
    public function getRecommendationAjax(Request $request)
    {
...
// $batteryLevel=90;
        ...
        if (Auth::check()) {
          ...
          //  dd( $recommended_items);
            ...
            return response()->json($recommended_items, 200);

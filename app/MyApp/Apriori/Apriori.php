 ...
 * '-)
 */
//////////////////// this is the real Algorithm ////////////////by ahmad
    ...
    { 
       ...
       for($i=0; $i<$num; $i++) 
           
          {
             ...
             $tmp  = explode($this->delimiter, implode(",",$db[$i]));
         
          
              
           /////////////////////////////// implode is added by me
    ...
    **/
    ...
    { 
       ...
       foreach($this->freqItmsts as $k => $v)
          {
             $arr = explode($this->delimiter, implode(",", (array)$k));
           /////////////////////////////////// emplode is added by me    ===
       ...
       foreach($this->freqItmsts as $k => $v)
          {
             $tmp  = '';
             $tmp1 = '';
             $k    = explode($this->delimiter, implode(",",  (array)$k));
           ////////////////////// added by me  implode

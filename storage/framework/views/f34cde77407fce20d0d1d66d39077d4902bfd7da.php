<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(route('product.index')); ?>"><img src="<?php echo e(URL::to('logo/iraqshop-logo.png')); ?>"  class="logo"></a>
        </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                      <a href="<?php echo e(route('product.shoppingCart')); ?>">
                        <small class="text-muted initialism"><?php echo e(trans('messages.welcome')); ?>: <?php echo e(Auth::user()->email); ?></small>
                      </a>
                  </li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i>
                                ...
                                <?php echo app('translator')->get('messages.user-management'); ?>
                                  <span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <?php if(Auth::check()): ?>
                            ...
                            <li><a href="<?php echo e(route('categories.index')); ?>">
                                              <i class="fa fa-sign-out" aria-hidden="true"></i>
                                                <?php echo e(trans('messages.add-new-category')); ?></a></li>
                            <li><a href="<?php echo e(route('products.add')); ?>">
                                                        <i class="fa fa-sign-out" aria-hidden="true"></i>
                                                          <?php echo e(trans('messages.add-new-products')); ?></a></li>
                        ...
                        <li><a href="<?php echo e(route('user.signin')); ?>"><i class="fa fa-sign-in" aria-hidden="true"></i> <?php echo e(trans('messages.sign-in')); ?> </li></a>

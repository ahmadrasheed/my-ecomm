...
<head>
  ...
  <?php /* Use the line below instead of the above if you need to cache the css. */ ?>
  <?php /* <link rel="stylesheet" href="<?php echo e(asset('/vendor/laravel-filemanager/css/lfm.css')); ?>"> */ ?>
...
<body>
  ...
  <?php /* Use the line below instead of the above if you need to cache the script. */ ?>
  <?php /* <script src="<?php echo e(asset('vendor/laravel-filemanager/js/script.js')); ?>"></script> */ ?>
  <script>
    $.fn.fab = function () {
      var menu = this;

...
--
-- Table structure for table `apriori_gs`
--

DROP TABLE IF EXISTS `apriori_gs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `apriori_gs` (
...
--
-- Dumping data for table `apriori_gs`
--

LOCK TABLES `apriori_gs` WRITE;
/*!40000 ALTER TABLE `apriori_gs` DISABLE KEYS */;
/*!40000 ALTER TABLE `apriori_gs` ENABLE KEYS */;
UNLOCK TABLES;
